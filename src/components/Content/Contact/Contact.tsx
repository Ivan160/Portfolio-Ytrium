...
const Contact = () => {
   ...
   const beforeBlock = useRef<any>(null);
   const line = useRef<any>(null);

   useEffect(() => {
      document.title = 'Ytrium | Contact';
   ...
   const onClick = (e: any) => {
      if (e.target) {
         e.preventDefault();
         navigator.clipboard.writeText('ivanandrosc@gmail.com');
         ...
         anime({
            ...
            translateY: [
               { value: [ '-50%', '-120%' ], easing: 'linear', duration: 300 },
               { value: '-170%', easing: 'linear', delay: 350, duration: 300 }
            ]
         });
      }
   };
            ...
            <div className={style.network} id='link_network'>
               <a href='/' target="_blank" rel="noopener noreferrer">
                  <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <path
                        d="M33.3125 12.8203C33.2187 12.7891 33.125 12.7578 33.0312 12.7266C32.9141 12.6953 32.7891 12.6797 32.6719 12.6563C32.1953 12.5625 31.6797 12.4922 31.0703 12.4922C25.8516 12.4922 22.5469 16.2812 21.4609 17.75V12.5H12.5V40H21.4453V25C21.4453 25 28.2031 15.5859 31.0547 22.5C31.0547 28.6719 31.0547 40 31.0547 40H40V21.4453C40 17.2891 37.1562 13.8281 33.3125 12.8203Z"/>
                     <path
                        d="M4.375 8.75C6.79125 8.75 8.75 6.79125 8.75 4.375C8.75 1.95875 6.79125 0 4.375 0C1.95875 0 0 1.95875 0 4.375C0 6.79125 1.95875 8.75 4.375 8.75Z"/>
                  </svg>
               </a>
